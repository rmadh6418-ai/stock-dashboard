...
# 카카오톡 토큰 키 (GitHub Secrets에서 가져옴)
KAKAO_TOKEN = st.secrets.get("KAKAO_TOKEN", "YOUR_KAKAO_TOKEN")

# FRED 데이터 로그인 없이 직접 가져오는 함수
...
with st.spinner("데이터를 불러오는 중입니다... (약 10초 소요)"):
